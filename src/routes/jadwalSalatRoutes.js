...
const { jadwalSalatHandler } = require('../controllers/jadwalSalatController');
...
/**
 * Rute untuk menangani jadwal salat
 */
router.post('/', async (req, res, next) => {
    try {
        await jadwalSalatHandler(req, res);
    } catch (error) {
        console.error('Error in /jadwal-salat route:', error.message);
