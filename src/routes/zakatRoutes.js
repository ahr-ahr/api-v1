...
const { zakatHandler } = require('../controllers/zakatController');
...
/**
 * Rute untuk menangani kalkulator zakat
 */
router.post('/', async (req, res, next) => {
    try {
        await zakatHandler(req, res);
    } catch (error) {
        console.error('Error in /zakat route:', error.message);
