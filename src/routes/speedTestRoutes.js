...
const { speedTestHandler } = require('../controllers/speedTestController');
...
/**
 * Rute untuk menangani speedTest
 */
router.post('/', async (req, res, next) => {
    try {
        await speedTestHandler(req, res);
    } catch (error) {
        console.error('Error in /speedtest route:', error.message);
